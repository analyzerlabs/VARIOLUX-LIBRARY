...
class variolux{
    private:
        const char* ssid = "Smart Solutions Labs";
    ...
    public:  
        ...
        void firmwareUpdate(){
            secureEsp32FOTA fota ("ECU-VL-002", 1);
            fota._host="raw.githubusercontent.com"; //e.g. example.com
            fota._descriptionOfFirmwareURL="https://github.com/analyzerlabs/VARIOLUX-LIBRARY/main/src/firmware/firmware.json"; //e.g. /my-fw-versions/firmware.json
            fota._certificate=test_root_ca;
            fota.clientForOta=clientForOta;

            bool shouldExecuteFirmwareUpdate=fota.execHTTPSCheck();
